...
package com.h.system.mystore.infra.paymnet.domain.service;
...
import com.h.system.mystore.infra.paymnet.domain.repository.PaymentRepository;
...
public class PaymentService {
     ...
     * 正式项目中，一般不会自己零开始写分布式事务，而是引入一套事务中间件（譬如Seata），具体分布式事务的内容请参考文档
     */
